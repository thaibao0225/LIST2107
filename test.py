...
from net import Unet,sepnet

## Unet,sepnet,MultiResUnet,dense_UNet,segnet,UNetplusplus,cbam_Unet
...
def main():
    ...
    args = joblib.load('models/LiTS_Unet_lym/2023-10-28-06-48-19/args.pkl')
    print('Config -----')
    for arg in vars(args):
        print('%s: %s' %(arg, getattr(args, arg)))
    print('------------')
    joblib.dump(args, 'models/LiTS_Unet_lym/2023-10-28-06-48-19/args.pkl')
    ...
    model.load_state_dict(torch.load('models/LiTS_Unet_lym/2023-10-28-06-48-19/epoch233-0.9736-0.8648_model.pth'))
    model.eval()
